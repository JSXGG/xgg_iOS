...
+ (UIBarButtonItem *)itemWithTargat:(id)target action:(SEL)action image:(NSString *)image highImage:(NSString *)highImage{
    ...
    // 设置图片
    UIImage *Templeimage = [[UIImage imageNamed:image]imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
    btn.tintColor = [UIColor whiteColor];
    [btn setBackgroundImage:Templeimage forState:UIControlStateNormal];
