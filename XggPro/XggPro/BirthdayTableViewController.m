...
@interface BirthdayTableViewController ()<UISearchControllerDelegate>
...
- (void)viewDidLoad {
    ...
    self.title=@"生日管理";
    [self.tableView registerNib:[UINib nibWithNibName:@"birthdayTableViewCell" bundle:[NSBundle mainBundle]] forCellReuseIdentifier:@"birthdayTableViewCell"];
