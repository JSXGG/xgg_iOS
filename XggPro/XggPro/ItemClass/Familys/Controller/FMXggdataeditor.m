...
#import "FMUserItem.h"
#import "XGGHeader.h"
#import "FMAddUserItem.h"
#import "FMAdduserCell.h"
#import "FMAddUserInput.h"
#import "FMAdduserfaceCell.h"
#import "KWareaManageVC.h"
@interface FMXggdataeditor ()<UITableViewDelegate,UITableViewDataSource>{
    getEditorResult _EditorResult;
}
@property(nonatomic,strong)FMUserItem *userItem;
...
@implementation FMXggdataeditor
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.row == 0) {
        ...
        __weak typeof(self)WeakSelf = self;
        FMaddUserItem *UserItem = self.listItems[indexPath.row];
...
-(void)reloadViewWithDic:(NSDictionary *)dic{
    for (FMaddUserItem *userItem in self.listItems){
